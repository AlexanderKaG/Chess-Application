...
class PieceTest {
    ...
    void pieceShouldNotBeCapturedUponCreation() {
        Piece piece = new Piece(PieceType.KING, Color.WHITE, SquareCoordinate.E1);
    ...
    void pieceShouldBeOnSquareE1() {
        ...
        Piece piece = new Piece(PieceType.KING, Color.WHITE, SquareCoordinate.E1);
        assertEquals(squareCoordinate, piece.getCurrentSquare());
    }
    ...
    void pieceShouldMoveFromE1ToE2() {
        ...
        Piece piece = new Piece(PieceType.KING, Color.WHITE, SquareCoordinate.E1);
        assertEquals(squareCoordinate, piece.move(SquareCoordinate.E2));
    }
